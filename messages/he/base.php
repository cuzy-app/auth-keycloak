...
return array (
  ...
  'Button {AddMapper} (for Humhub version <20: {AddBuiltin}) and add theses attributes:' => 'כפתור {AddMapper} (עבור גרסת Humhub <20: {AddBuiltin} ) והוסף תכונות אלה:',
  ...
  '{ClientScope} tab -> click on the first {scopeName} (for Humhub version <20: {Mappers} tab):' => 'הכרטיסייה {ClientScope} -> לחץ על ה- {scopeName} הראשון (עבור גרסת Humhub <20: כרטיסיית {Mappers} ):',
  '{Credentials} tab: copy the secret key' => 'כרטיסיית {Credentials} : העתק את המפתח הסודי',
  '{Settings} tab -> {ClientAuthenticationOn} (for Humhub version <20: {AccessTypeValue}).' => 'כרטיסיית {Settings} -> {ClientAuthenticationOn} (עבור גרסת Humhub <20: {AccessTypeValue} ).',
