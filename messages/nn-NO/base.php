...
return array (
  ...
  'Base URL' => 'Base URL',
  'Button {AddMapper} (for Humhub version <20: {AddBuiltin}) and add theses attributes:' => 'Trykk på {AddMapper} (for Humhub-versjon <20: {AddBuiltin} ) og legg til disse attributtene:',
  ...
  'If enabled, you should also enable {removeKeycloakSessionsAfterLogoutAttrLabel}, otherwise users cannot logout.' => 'Hvis aktivert, bør du også aktivere {removeKeycloakSessionsAfterLogoutAttrLabel} , ellers kan ikke brukere logge ut.',
  ...
  'Possible only if {newUsersCanRegister} is allowed in Administration -> Users -> Settings.' => 'Kun mulig hvis {newUsersCanRegister} er tillatt i Administrasjon -> Brukere -> Innstillinger.',
  ...
  '{ClientScope} tab -> click on the first {scopeName} (for Humhub version <20: {Mappers} tab):' => '{ClientScope} fanen -> klikk på det første {scopeName} (for Humhub-versjon <20: {Mappers} fanen):',
  '{Credentials} tab: copy the secret key' => '{Credentials} : kopier den hemmelige nøkkelen',
  '{Settings} tab -> {ClientAuthenticationOn} (for Humhub version <20: {AccessTypeValue}).' => '{Settings} -fanen -> {ClientAuthenticationOn} (for Humhub-versjon <20: {AccessTypeValue} ).',
