...
return array (
  ...
  'Base URL' => 'URL پایه',
  'Button {AddMapper} (for Humhub version <20: {AddBuiltin}) and add theses attributes:' => '{AddMapper} (برای نسخه Humhub <20: {AddBuiltin} ) را فشار دهید و این ویژگی ها را اضافه کنید:',
  ...
  'Possible only if {newUsersCanRegister} is allowed in Administration -> Users -> Settings.' => 'فقط در صورتی امکان پذیر است که {newUsersCanRegister} در Administration -> Users -> Settings مجاز باشد.',
  ...
  '{ClientScope} tab -> click on the first {scopeName} (for Humhub version <20: {Mappers} tab):' => 'تب {ClientScope} -> روی اولین {scopeName} کلیک کنید (برای نسخه Humhub <20: برگه {Mappers} ):',
  '{Credentials} tab: copy the secret key' => 'برگه {Credentials} : کلید مخفی را کپی کنید',
  '{Settings} tab -> {ClientAuthenticationOn} (for Humhub version <20: {AccessTypeValue}).' => 'برگه {Settings} -> {ClientAuthenticationOn} (برای نسخه Humhub <20: {AccessTypeValue} ).',
