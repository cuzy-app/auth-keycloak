...
return array (
  ...
  'Sync HumHub towards Keycloak (but no removal on Keycloak)' => 'همگام سازی HumHub با Keycloak (اما حذف در Keycloak وجود ندارد)',
  ...
  'Sync both ways (but no removal on HumHub)' => 'همگام سازی هر دو روش (اما حذف در HumHub وجود ندارد)',
  ...
  'Update user\'s email on HumHub when changed on Keycloak' => 'با تغییر در Keycloak ایمیل کاربر را در HumHub به روز کنید',
