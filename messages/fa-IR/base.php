...
return array (
  ...
  'Base URL' => 'URL پایه',
  'Button {AddMapper} (for Keycloak version <20: {AddBuiltin}) and add theses attributes:' => '{AddMapper} (برای نسخه Humhub <20: {AddBuiltin} ) را فشار دهید و این ویژگی ها را اضافه کنید:',
  ...
  '{ClientScope} tab -> click on the first {scopeName} (for Keycloak version <20: {Mappers} tab):' => 'تب {ClientScope} -> روی اولین {scopeName} کلیک کنید (برای نسخه Humhub <20: برگه {Mappers} ):',
