...
return array (
  ...
  'Button {AddMapper} (for Humhub version <20: {AddBuiltin}) and add theses attributes:' => 'Butoni {AddMapper} (për versionin Humhub <20: {AddBuiltin} ) dhe shtoni këto atribute:',
  ...
  'If enabled, you should also enable {removeKeycloakSessionsAfterLogoutAttrLabel}, otherwise users cannot logout.' => 'Nëse aktivizohet, duhet të aktivizoni gjithashtu {removeKeycloakSessionsAfterLogoutAttrLabel} , përndryshe përdoruesit nuk mund të dalin.',
  ...
  'Possible only if {newUsersCanRegister} is allowed in Administration -> Users -> Settings.' => 'E mundur vetëm nëse {newUsersCanRegister} lejohet te Administrata -> Përdoruesit -> Cilësimet.',
  ...
  '{ClientScope} tab -> click on the first {scopeName} (for Humhub version <20: {Mappers} tab):' => 'Skeda {ClientScope} -> klikoni në {scopeName} i parë (për versionin Humhub <20: skeda {Mappers} ):',
  '{Credentials} tab: copy the secret key' => 'Skeda e {Credentials} : kopjoni çelësin sekret',
  '{Settings} tab -> {ClientAuthenticationOn} (for Humhub version <20: {AccessTypeValue}).' => 'Skeda e {Settings} -> {ClientAuthenticationOn} (për versionin Humhub <20: {AccessTypeValue} ).',
