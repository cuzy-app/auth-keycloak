...
return array (
  ...
  'Sync HumHub towards Keycloak' => 'Synchroniseer HumHub met Keycloak',
  'Sync HumHub towards Keycloak (but no removal on Keycloak)' => 'Synchroniseer HumHub met Keycloak (maar geen verwijdering op Keycloak)',
  'Sync Keycloak towards HumHub' => 'Synchroniseer Keycloak met HumHub',
  'Sync Keycloak towards HumHub (but no removal on HumHub)' => 'Synchroniseer Keycloak met HumHub (maar geen verwijdering op HumHub)',
  'Sync both ways' => 'Synchroniseer in beide richtingen',
  'Sync both ways (but no removal on HumHub)' => 'Synchroniseer beide kanten op (maar geen verwijdering op HumHub)',
  ...
  'Update user\'s email on HumHub when changed on Keycloak' => 'Update het e-mailadres van de gebruiker op HumHub wanneer dit is gewijzigd op Keycloak',
