...
return array (
  ...
  'New password' => '새 비밀번호',
  'No sync' => '동기화 없음',
  'On Keycloak, create a client for HumHub and configure it:' => 'Keycloak에서 HumHub용 클라이언트를 생성하고 구성합니다.',
  ...
  'Sync HumHub towards Keycloak' => 'HumHub를 Keycloak으로 동기화',
  'Sync HumHub towards Keycloak (but no removal on Keycloak)' => 'HumHub를 Keycloak으로 동기화합니다(단, Keycloak에서는 제거되지 않음).',
  'Sync Keycloak towards HumHub' => 'HumHub에 Keycloak 동기화',
  'Sync Keycloak towards HumHub (but no removal on HumHub)' => 'HumHub에 Keycloak 동기화(HumHub에서는 제거되지 않음)',
  'Sync both ways' => '양방향 동기화',
  'Sync both ways (but no removal on HumHub)' => '양방향 동기화(HumHub에서는 제거되지 않음)',
  ...
  'Update user\'s email on HumHub when changed on Keycloak' => 'Keycloak에서 변경되면 HumHub에서 사용자 이메일 업데이트',
