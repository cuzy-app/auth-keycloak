...
return array (
  ...
  'Button {AddMapper} (for Humhub version <20: {AddBuiltin}) and add theses attributes:' => 'Tlačidlo {AddMapper} (pre verziu Humhub <20: {AddBuiltin} ) a pridajte tieto atribúty:',
  ...
  '{ClientScope} tab -> click on the first {scopeName} (for Humhub version <20: {Mappers} tab):' => 'Karta {ClientScope} -> kliknite na prvý {scopeName} (pre verziu Humhub <20: karta {Mappers} ):',
  '{Credentials} tab: copy the secret key' => 'Karta {Credentials} : skopírujte tajný kľúč',
  '{Settings} tab -> {ClientAuthenticationOn} (for Humhub version <20: {AccessTypeValue}).' => 'Karta {Settings} -> {ClientAuthenticationOn} (pre verziu Humhub <20: {AccessTypeValue} ).',
