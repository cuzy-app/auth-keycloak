...
return array (
  ...
  'Base URL' => '基本网址',
  'Button {AddMapper} (for Humhub version <20: {AddBuiltin}) and add theses attributes:' => '按鈕{AddMapper} （對於 Humhub 版本 <20: {AddBuiltin} ）並添加這些屬性：',
  ...
  '{ClientScope} tab -> click on the first {scopeName} (for Humhub version <20: {Mappers} tab):' => '{ClientScope}選項卡 -> 單擊第一個{scopeName} （對於 Humhub 版本 <20： {Mappers}選項卡）：',
  '{Credentials} tab: copy the secret key' => '{Credentials}选项卡：复制密钥',
  '{Settings} tab -> {ClientAuthenticationOn} (for Humhub version <20: {AccessTypeValue}).' => '{Settings}選項卡 -> {ClientAuthenticationOn} （對於 Humhub 版本 <20： {AccessTypeValue} ）。',
