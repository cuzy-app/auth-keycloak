...
return array (
  ...
  'New password' => '新密码',
  'No sync' => '不同步',
  'On Keycloak, create a client for HumHub and configure it:' => '在 Keycloak 上，為 HumHub 建立客戶端並配置它：',
  'Password confirmation does not match.' => '密码确认不匹配。',
  'Realm name' => '领域名称',
  'Remove user\'s Keycloak sessions after logout' => '注销后删除用户的 Keycloak 会话',
  'Sync HumHub towards Keycloak' => '將 HumHub 同步到 Keycloak',
  'Sync HumHub towards Keycloak (but no removal on Keycloak)' => '將 HumHub 與 Keycloak 同步（但不會在 Keycloak 上刪除）',
  'Sync Keycloak towards HumHub' => '將 Keycloak 同步到 HumHub',
  'Sync Keycloak towards HumHub (but no removal on HumHub)' => '將 Keycloak 與 HumHub 同步（但在 HumHub 上不刪除）',
  'Sync both ways' => '双向同步',
  'Sync both ways (but no removal on HumHub)' => '雙向同步（但在 HumHub 上不刪除）',
  ...
  'Title of the button' => '按鈕的標題',
  'Update user\'s email on HumHub when changed on Keycloak' => '當 Keycloak 上的使用者電子郵件發生變更時，更新 HumHub 上的使用者電子郵件',
