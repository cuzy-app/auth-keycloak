...
return array (
  ...
  'Base URL' => 'Basis URL',
  'Button {AddMapper} (for Humhub version <20: {AddBuiltin}) and add theses attributes:' => 'Knap {AddMapper} (for Humhub version <20: {AddBuiltin} ) og tilføj disse attributter:',
  ...
  '{ClientScope} tab -> click on the first {scopeName} (for Humhub version <20: {Mappers} tab):' => '{ClientScope} fanen -> klik på det første {scopeName} (for Humhub-version <20: {Mappers} fanen):',
  '{Credentials} tab: copy the secret key' => '{Credentials} : Kopier den hemmelige nøgle',
  '{Settings} tab -> {ClientAuthenticationOn} (for Humhub version <20: {AccessTypeValue}).' => 'Fanen {Settings} -> {ClientAuthenticationOn} (for Humhub version <20: {AccessTypeValue} ).',
