...
return array (
  ...
  'Button {AddMapper} (for Humhub version <20: {AddBuiltin}) and add theses attributes:' => 'Κουμπί {AddMapper} (για έκδοση Humhub <20: {AddBuiltin} ) και προσθέστε τα παρακάτω χαρακτηριστικά:',
  ...
  'Possible only if {newUsersCanRegister} is allowed in Administration -> Users -> Settings.' => 'Είναι δυνατό μόνο εάν επιτρέπεται το {newUsersCanRegister} στη Διαχείριση -> Χρήστες -> Ρυθμίσεις.',
  ...
  '{ClientScope} tab -> click on the first {scopeName} (for Humhub version <20: {Mappers} tab):' => 'Καρτέλα {ClientScope} -> κάντε κλικ στο πρώτο {scopeName} (για έκδοση Humhub <20: Καρτέλα {Mappers} ):',
  '{Credentials} tab: copy the secret key' => 'Καρτέλα {Credentials} : αντιγράψτε το μυστικό κλειδί',
  '{Settings} tab -> {ClientAuthenticationOn} (for Humhub version <20: {AccessTypeValue}).' => 'Καρτέλα {Settings} -> {ClientAuthenticationOn} (για έκδοση Humhub <20: {AccessTypeValue} ).',
