...
return array (
  ...
  'Base URL' => 'ベースURL',
  'Button {AddMapper} (for Humhub version <20: {AddBuiltin}) and add theses attributes:' => 'ボタン{AddMapper} (Humhub バージョン <20 の場合: {AddBuiltin} ) を選択し、これらの属性を追加します。',
  ...
  '{ClientScope} tab -> click on the first {scopeName} (for Humhub version <20: {Mappers} tab):' => '{ClientScope}タブ -> 最初の{scopeName}をクリックします (Humhub バージョン <20: {Mappers}タブの場合):',
  '{Credentials} tab: copy the secret key' => '[ {Credentials} ]タブ：秘密鍵をコピーします',
  '{Settings} tab -> {ClientAuthenticationOn} (for Humhub version <20: {AccessTypeValue}).' => '{Settings} ] タブ -> {ClientAuthenticationOn} (Humhub バージョン <20: {AccessTypeValue}の場合)。',
