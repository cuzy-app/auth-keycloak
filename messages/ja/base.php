...
return array (
  ...
  'No sync' => '同期なし',
  'On Keycloak, create a client for HumHub and configure it:' => 'Keycloak で、HumHub のクライアントを作成し、設定します。',
  ...
  'Sync HumHub towards Keycloak' => 'HumHubをKeycloakに同期する',
  'Sync HumHub towards Keycloak (but no removal on Keycloak)' => 'HumHub を Keycloak に同期します (ただし、Keycloak では削除されません)',
  'Sync Keycloak towards HumHub' => 'KeycloakをHumHubに同期する',
  'Sync Keycloak towards HumHub (but no removal on HumHub)' => 'Keycloak を HumHub に同期します (ただし、HumHub では削除されません)',
  'Sync both ways' => '双方向で同期する',
  'Sync both ways (but no removal on HumHub)' => '双方向で同期します（ただし、HumHub では削除されません）',
  ...
  'Title of the button' => 'ボタンのタイトル',
  'Update user\'s email on HumHub when changed on Keycloak' => 'Keycloak で変更されたら HumHub のユーザーのメール アドレスを更新する',
