...
return array (
  ...
  'Sync HumHub towards Keycloak (but no removal on Keycloak)' => 'Synchronizujte HumHub s Keycloak (ale bez odstranění na Keycloak)',
  'Sync Keycloak towards HumHub' => 'Synchronizujte Keycloak směrem k HumHubu',
  'Sync Keycloak towards HumHub (but no removal on HumHub)' => 'Synchronizovat Keycloak s HumHub (ale bez odstranění na HumHubu)',
  ...
  'Update user\'s email on HumHub when changed on Keycloak' => 'Aktualizujte e-mail uživatele na HumHubu při změně na Keycloak',
