...
return array (
  ...
  'On Keycloak, create a client for HumHub and configure it:' => 'В Keycloak создайте клиент для HumHub и настройте его:',
  ...
  'Sync HumHub towards Keycloak (but no removal on Keycloak)' => 'Синхронизируйте HumHub с Keycloak (но не удаляйте Keycloak)',
  'Sync Keycloak towards HumHub' => 'Синхронизировать Keycloak с HumHub',
  'Sync Keycloak towards HumHub (but no removal on HumHub)' => 'Синхронизировать Keycloak с HumHub (но не удалять с HumHub)',
  'Sync both ways' => 'Синхронизировать в обе стороны',
  'Sync both ways (but no removal on HumHub)' => 'Синхронизировать в обоих направлениях (но без удаления на HumHub)',
  ...
  'Update user\'s email on HumHub when changed on Keycloak' => 'Обновить адрес электронной почты пользователя на HumHub при изменении на Keycloak',
