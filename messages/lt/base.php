...
return array (
  ...
  'Button {AddMapper} (for Humhub version <20: {AddBuiltin}) and add theses attributes:' => 'Mygtukas {AddMapper} (skirtas <20 Humhub versijai: {AddBuiltin} ) ir pridėkite šiuos atributus:',
  ...
  '{ClientScope} tab -> click on the first {scopeName} (for Humhub version <20: {Mappers} tab):' => '„ {ClientScope} “ skirtukas -> spustelėkite pirmąjį „ {scopeName} (jei „Humhub“ versija <20: skirtukas „ {Mappers} “):',
  '{Credentials} tab: copy the secret key' => '{Credentials} skirtukas: nukopijuokite slaptąjį raktą',
  '{Settings} tab -> {ClientAuthenticationOn} (for Humhub version <20: {AccessTypeValue}).' => 'Skirtukas {Settings} -> {ClientAuthenticationOn} (skirta Humhub versijai <20: {AccessTypeValue} ).',
