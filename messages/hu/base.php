...
return array (
  ...
  'Base URL' => 'Alap URL',
  'Button {AddMapper} (for Keycloak version <20: {AddBuiltin}) and add theses attributes:' => 'Nyomja meg az {AddMapper} gombot (<20-as Humhub verzióhoz: {AddBuiltin} ), és adja hozzá a következő attribútumokat:',
  ...
  '{ClientScope} tab -> click on the first {scopeName} (for Keycloak version <20: {Mappers} tab):' => '{ClientScope} lap -> kattintson az első {scopeName} (<20-as Humhub-verzió esetén: {Mappers} lap):',
