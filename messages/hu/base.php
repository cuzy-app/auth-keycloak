...
return array (
  ...
  'Keycloak attribute to use to get username on account creation: `preferred_username` (to use Keycloak username), `sub` (to use Keycloak ID) or other custom Token Claim Name' => 'Keycloak attribútum, amellyel fióklétrehozáskor felhasználónév kérhető: `preferred_username` (a Keycloak felhasználónév használatához), `sub` (a Keycloak ID használatához) vagy más egyéni Token Claim név',
