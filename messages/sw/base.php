...
return array (
  ...
  'Automatic login' => 'Kuingia kiotomatiki',
  'Base URL' => 'URL ya msingi',
  'Button {AddMapper} (for Keycloak version <20: {AddBuiltin}) and add theses attributes:' => 'Button {AddMapper} (kwa toleo la Keycloak <20: {AddBuiltin} ) na uongeze sifa za nadharia:',
  ...
  'Edit {usernameAttribute} and in {TokenClaimName}, replace {preferredUsernameAttribute} with {idAttribute}' => 'Hariri {usernameAttribute} na katika {TokenClaimName} , badilisha {preferredUsernameAttribute} na {idAttribute}',
  ...
  'If enabled, you should also enable {removeKeycloakSessionsAfterLogoutAttrLabel}, otherwise users cannot logout.' => 'Ikiwashwa, unapaswa pia kuwezesha {removeKeycloakSessionsAfterLogoutAttrLabel} , vinginevyo watumiaji hawawezi kutoka.',
  ...
  'On Keycloak, create a client for Humhub and configure it:' => 'Kwenye Keycloak, tengeneza mteja wa Humhub na uisanidi:',
  'Password confirmation does not match.' => 'Uthibitishaji wa nenosiri haulingani.',
  'Possible only if {newUsersCanRegister} is allowed in Administration -> Users -> Settings.' => 'Inawezekana tu ikiwa {newUsersCanRegister} inaruhusiwa katika Utawala -> Watumiaji -> Mipangilio.',
  ...
  'Sync Keycloak towards Humhub' => 'Sawazisha Kitufe kuelekea Humhub',
  ...
  'Title of the button (if autoLogin is disabled)' => 'Kichwa cha kitufe (ikiwa AutoLogin imezimwa)',
  ...
  '{ClientScope} tab -> click on the first {scopeName} (for Keycloak version <20: {Mappers} tab):' => 'Kichupo {ClientScope} -> bofya kwenye {scopeName} ya kwanza (kwa toleo la Keycloak <20: kichupo {Mappers} ):',
