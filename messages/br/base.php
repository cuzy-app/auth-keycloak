...
return [
    ...
    'Automatic login' => '',
    'Base URL' => '',
    'Button {AddMapper} (for Humhub version <20: {AddBuiltin}) and add theses attributes:' => '',
    ...
    '{ClientScope} tab -> click on the first {scopeName} (for Humhub version <20: {Mappers} tab):' => '',
    '{Credentials} tab: copy the secret key' => '',
    '{Settings} tab -> {ClientAuthenticationOn} (for Humhub version <20: {AccessTypeValue}).' => '',
