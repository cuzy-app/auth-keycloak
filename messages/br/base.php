...
return [
    ...
    'Automatic login' => '',
    'Base URL' => '',
    'Button {AddMapper} (for Keycloak version <20: {AddBuiltin}) and add theses attributes:' => '',
    ...
    '{ClientScope} tab -> click on the first {scopeName} (for Keycloak version <20: {Mappers} tab):' => '',
