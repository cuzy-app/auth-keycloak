...
return array (
  ...
  'Humhub to Keycloak sync is done in real time. Keycloak to Humhub sync is done once a day. Keycloak subgroups are not synced.' => 'Humhub to Keycloak sinkronizazioa denbora errealean egiten da. Keycloak Humhub-en sinkronizazioa egunean behin egiten da. Keycloak azpitaldeak ez dira sinkronizatzen.',
  ...
  'Sync Keycloak towards Humhub (but no removal on Humhub)' => 'Sinkronizatu Keycloak Humhub-era (baina ez da kendu Humhub-en)',
  ...
  'Sync both ways (but no removal on Keycloak or Humhub)' => 'Sinkronizatu bi modutan (baina ez da kendu Keycloak edo Humhub-en)',
  ...
  'Update user\'s email on Humhub when changed on Keycloak' => 'Eguneratu erabiltzailearen helbide elektronikoa Humhub-en Keycloak-en aldatzen denean',
  'Update user\'s email on Keycloak when changed on Humhub' => 'Eguneratu erabiltzailearen helbide elektronikoa Keycloak-en Humhub-en aldatzen denean',
