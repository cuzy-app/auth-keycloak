...
return array (
  ...
  'Base URL' => 'Pamata URL',
  'Button {AddMapper} (for Keycloak version <20: {AddBuiltin}) and add theses attributes:' => 'Poga {AddMapper} (Humhub versijai <20: {AddBuiltin} ) un pievienojiet šos atribūtus:',
  ...
  '{ClientScope} tab -> click on the first {scopeName} (for Keycloak version <20: {Mappers} tab):' => '{ClientScope} —> noklikšķiniet uz pirmās {scopeName} (Humhub versijai <20: cilne {Mappers} ):',
