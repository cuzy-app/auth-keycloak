...
return array (
  ...
  'Base URL' => 'Pamata URL',
  'Button {AddMapper} (for Humhub version <20: {AddBuiltin}) and add theses attributes:' => 'Poga {AddMapper} (Humhub versijai <20: {AddBuiltin} ) un pievienojiet šos atribūtus:',
  ...
  'Possible only if {newUsersCanRegister} is allowed in Administration -> Users -> Settings.' => 'Iespējama tikai tad, ja sadaļā Administrācija -> Lietotāji -> Iestatījumi ir atļauts {newUsersCanRegister} .',
  ...
  '{ClientScope} tab -> click on the first {scopeName} (for Humhub version <20: {Mappers} tab):' => '{ClientScope} —> noklikšķiniet uz pirmās {scopeName} (Humhub versijai <20: cilne {Mappers} ):',
  '{Credentials} tab: copy the secret key' => 'Cilne {Credentials} dati: kopējiet slepeno atslēgu',
  '{Settings} tab -> {ClientAuthenticationOn} (for Humhub version <20: {AccessTypeValue}).' => 'Cilne {Settings} —> {ClientAuthenticationOn} (Humhub versijai <20: {AccessTypeValue} ).',
