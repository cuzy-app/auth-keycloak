...
return array (
  ...
  'Base URL' => 'ቤዝ URL',
  'Button {AddMapper} (for Humhub version <20: {AddBuiltin}) and add theses attributes:' => '{AddMapper} አዝራር (ለHumhub ስሪት <20: {AddBuiltin} ) እና የነዚህን ባህሪያት ያክሉ፡-',
  ...
  '{ClientScope} tab -> click on the first {scopeName} (for Humhub version <20: {Mappers} tab):' => '{ClientScope} ትር -> በመጀመሪያው የ {scopeName} ላይ ጠቅ ያድርጉ (ለHumhub ስሪት <20 {Mappers} ትር)፡-',
  '{Credentials} tab: copy the secret key' => '{Credentials} ትር፡ የሚስጥር ቁልፉን ይቅዱ',
  '{Settings} tab -> {ClientAuthenticationOn} (for Humhub version <20: {AccessTypeValue}).' => '{Settings} ትር -> {ClientAuthenticationOn} (ለHumhub ስሪት <20 {AccessTypeValue} )።',
