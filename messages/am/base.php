...
return array (
  ...
  'Sync HumHub towards Keycloak' => 'HumHubን ወደ በቁልፍ ሰሌዳ አስምር',
  'Sync HumHub towards Keycloak (but no removal on Keycloak)' => 'HumHubን ወደ በቁልፍ ሰሌዳ አስምር (ነገር ግን በቁልፍ ልብስ ላይ መወገድ የለም)',
  'Sync Keycloak towards HumHub' => 'የቁልፍ መደረቢያውን ወደ HumHub አመሳስል።',
  'Sync Keycloak towards HumHub (but no removal on HumHub)' => 'የቁልፍ ካባውን ወደ HumHub አመሳስል (ነገር ግን በHumHub ላይ ምንም መወገድ የለም)',
  'Sync both ways' => 'ሁለቱንም መንገዶች ያመሳስሉ',
  'Sync both ways (but no removal on HumHub)' => 'ሁለቱንም መንገዶች ያመሳስሉ (ነገር ግን በHumHub ላይ መወገድ የለም)',
