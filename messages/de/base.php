...
return array (
  ...
  'Sync HumHub towards Keycloak (but no removal on Keycloak)' => 'HumHub mit Keycloak synchronisieren (aber Keycloak nicht entfernen)',
  'Sync Keycloak towards HumHub' => 'Keycloak mit HumHub synchronisieren',
  'Sync Keycloak towards HumHub (but no removal on HumHub)' => 'Keycloak mit HumHub synchronisieren (aber keine Entfernung von HumHub)',
  'Sync both ways' => 'In beide Richtungen synchronisieren',
  'Sync both ways (but no removal on HumHub)' => 'In beide Richtungen synchronisieren (aber keine Entfernung auf HumHub)',
  ...
  'Update user\'s email on HumHub when changed on Keycloak' => 'E-Mail des Benutzers auf HumHub aktualisieren, wenn sie auf Keycloak geändert wird',
