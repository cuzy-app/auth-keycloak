...
return array (
  ...
  'Base URL' => 'Asosiy URL',
  'Button {AddMapper} (for Humhub version <20: {AddBuiltin}) and add theses attributes:' => '{AddMapper} tugmasini bosing (Humhub versiyasi <20: {AddBuiltin} ) va tezis atributlarini qo\'shing:',
  ...
  'If enabled, you should also enable {removeKeycloakSessionsAfterLogoutAttrLabel}, otherwise users cannot logout.' => 'Agar yoqilgan bo\'lsa, {removeKeycloakSessionsAfterLogoutAttrLabel} ni ham yoqishingiz kerak, aks holda foydalanuvchilar tizimdan chiqa olmaydi.',
  ...
  'Possible only if {newUsersCanRegister} is allowed in Administration -> Users -> Settings.' => 'Ma\'muriyat -> Foydalanuvchilar -> Sozlamalarda {newUsersCanRegister} ruxsat berilgan bo\'lsagina mumkin.',
  ...
  '{ClientScope} tab -> click on the first {scopeName} (for Humhub version <20: {Mappers} tab):' => '{ClientScope} yorlig\'i -> birinchi {scopeName} ustiga bosing (Humhub versiyasi <20 uchun: {Mappers} yorlig\'i):',
  '{Credentials} tab: copy the secret key' => '{Credentials} yorlig\'i: maxfiy kalitni nusxalash',
  '{Settings} tab -> {ClientAuthenticationOn} (for Humhub version <20: {AccessTypeValue}).' => '{Settings} yorlig\'i -> {ClientAuthenticationOn} (Humhub versiyasi <20: {AccessTypeValue} uchun).',
