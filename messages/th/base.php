...
return array (
  ...
  'Base URL' => 'URL ฐาน',
  'Button {AddBuiltin} and check theses attributes:' => 'ปุ่ม {AddBuiltin} และตรวจสอบคุณสมบัติเหล่านี้:',
  ...
  'Keycloak attribute to use to get username on account creation: `preferred_username` (to use Keycloak username), `sub` (to use Keycloak ID) or other custom Token Claim Name' => 'แอตทริบิวต์ Keycloak ที่จะใช้เพื่อรับชื่อผู้ใช้ในการสร้างบัญชี: `preferred_username\' (เพื่อใช้ชื่อผู้ใช้ Keycloak), `sub\' (เพื่อใช้ Keycloak ID) หรือชื่อการอ้างสิทธิ์ Token ที่กำหนดเองอื่น ๆ',
  ...
  'Possible only if anonymous registration is allowed in the admin users settings.' => 'เป็นไปได้ก็ต่อเมื่ออนุญาตให้ลงทะเบียนแบบไม่ระบุชื่อในการตั้งค่าผู้ใช้ที่เป็นผู้ดูแลระบบ',
  ...
  '{Mappers} tab:' => 'แท็บ {Mappers} :',
  '{Settings} tab -> {AccessType}: choose {confidential}. Save settings.' => 'แท็บ {Settings} -> {AccessType} : เลือกที่ {confidential} บันทึกการตั้งค่า.',
);
