...
return array (
  ...
  'Base URL' => '基本网址',
  'Button {AddMapper} (for Keycloak version <20: {AddBuiltin}) and add theses attributes:' => '按钮{AddMapper} （对于 Humhub 版本 <20: {AddBuiltin} ）并添加这些属性：',
  ...
  '{ClientScope} tab -> click on the first {scopeName} (for Keycloak version <20: {Mappers} tab):' => '{ClientScope}选项卡 -> 单击第一个{scopeName} （对于 Humhub 版本 <20： {Mappers}选项卡）：',
