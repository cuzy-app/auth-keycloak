...
return array (
  ...
  'Authentication to Keycloak API failed!' => '对 Keycloak API 的身份验证失败！',
  'Authentication to Keycloak API succeeded!' => 'Keycloak API 认证成功！',
  'Automatic login' => '自动登录',
  'Base URL' => '基本网址',
  'Button {AddMapper} (for Humhub version <20: {AddBuiltin}) and add theses attributes:' => '按钮{AddMapper} （对于 Humhub 版本 <20: {AddBuiltin} ）并添加这些属性：',
  ...
  'In admin, hide password fields in edit user form' => '在管理员中，在编辑用户表单中隐藏密码字段',
  ...
  '{ClientScope} tab -> click on the first {scopeName} (for Humhub version <20: {Mappers} tab):' => '{ClientScope}选项卡 -> 单击第一个{scopeName} （对于 Humhub 版本 <20： {Mappers}选项卡）：',
  '{Credentials} tab: copy the secret key' => '{Credentials}选项卡：复制密钥',
  '{Settings} tab -> {ClientAuthenticationOn} (for Humhub version <20: {AccessTypeValue}).' => '{Settings}选项卡 -> {ClientAuthenticationOn} （对于 Humhub 版本 <20： {AccessTypeValue} ）。',
