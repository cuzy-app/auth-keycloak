...
return array (
  ...
  'Sync HumHub towards Keycloak' => '将 HumHub 与 Keycloak 同步',
  'Sync HumHub towards Keycloak (but no removal on Keycloak)' => '将 HumHub 同步到 Keycloak（但不删除 Keycloak）',
  'Sync Keycloak towards HumHub' => '将 Keycloak 与 HumHub 同步',
  'Sync Keycloak towards HumHub (but no removal on HumHub)' => '将 Keycloak 同步到 HumHub（但不会删除 HumHub）',
  'Sync both ways' => '双向同步',
  'Sync both ways (but no removal on HumHub)' => '双向同步（但 HumHub 上不会删除）',
  ...
  'Title of the button' => '按钮的标题',
  'Update user\'s email on HumHub when changed on Keycloak' => '当 Keycloak 上的电子邮件发生变化时，更新 HumHub 上的用户电子邮件',
