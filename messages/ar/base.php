...
return array (
  ...
  'On Keycloak, create a client for HumHub and configure it:' => 'على Keycloak، قم بإنشاء عميل لـ HumHub وقم بتكوينه:',
  ...
  'Sync HumHub towards Keycloak' => 'مزامنة HumHub مع Keycloak',
  'Sync HumHub towards Keycloak (but no removal on Keycloak)' => 'مزامنة HumHub مع Keycloak (ولكن لا توجد إزالة على Keycloak)',
  'Sync Keycloak towards HumHub' => 'مزامنة Keycloak نحو HumHub',
  'Sync Keycloak towards HumHub (but no removal on HumHub)' => 'مزامنة Keycloak مع HumHub (ولكن لا توجد إزالة على HumHub)',
  'Sync both ways' => 'مزامنة كلا الاتجاهين',
  'Sync both ways (but no removal on HumHub)' => 'المزامنة في كلا الاتجاهين (ولكن لا توجد إزالة على HumHub)',
  ...
  'Update user\'s email on HumHub when changed on Keycloak' => 'قم بتحديث البريد الإلكتروني للمستخدم على HumHub عند تغييره على Keycloak',
