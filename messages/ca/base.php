...
return array (
  ...
  'Keycloak attribute to use to get username on account creation: `preferred_username` (to use Keycloak username), `sub` (to use Keycloak ID) or other custom Token Claim Name' => 'Atribut Keycloak que s\'ha d\'utilitzar per obtenir el nom d\'usuari en la creació del compte: `preferred_username` (per utilitzar el nom d\'usuari Keycloak), `sub` (per utilitzar l\'identificador de Keycloak) o un altre nom de reclamació de testimoni personalitzat',
