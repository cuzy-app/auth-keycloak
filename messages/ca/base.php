...
return array (
  ...
  'Base URL' => 'URL base',
  'Button {AddMapper} (for Humhub version <20: {AddBuiltin}) and add theses attributes:' => 'Botó {AddMapper} (per a la versió Humhub <20: {AddBuiltin} ) i afegiu aquests atributs:',
  ...
  '{ClientScope} tab -> click on the first {scopeName} (for Humhub version <20: {Mappers} tab):' => 'Pestanya {ClientScope} -> feu clic al primer {scopeName} (per a la versió Humhub <20: pestanya {Mappers} ):',
  '{Credentials} tab: copy the secret key' => 'Pestanya {Credentials} : copieu la clau secreta',
  '{Settings} tab -> {ClientAuthenticationOn} (for Humhub version <20: {AccessTypeValue}).' => 'Pestanya {Settings} -> {ClientAuthenticationOn} (per a la versió de Humhub <20: {AccessTypeValue} ).',
